...
filter.klztest = function(unit)
  local i = 1
  while UnitBuff(unit, i) do
    if UnitBuff(unit, i) == "Interface\\Icons\\Ability_Shaman_WaterShield" then
      return true
    end
    i = i + 1
  end
...
filter.klztest2 = function(unit)
  local i = 1
  while UnitDebuff(unit, i) do
    if UnitDebuff(unit, i) == "Interface\\Icons\\INV_Misc_Bandage_08" then
      return true
    end
    i = i + 1
  end
